...
---pl/sql中的if判断   &ii;表示需要输入一个变量复制给i
---输入小于18的数字，输出未成年
---输入大于18小于40的数字，输出中年人
---输入大于40的数字，输出老年人 
declare
...
--将资料中的ojdbc14.jar拷贝到无中文特殊符号目录   执行以下install命令  安装到本地仓库
--mvn install:install-file -Dfile=E:\xczxbefor\oracle\ojdbc14.jar -DgroupId=com.oracle -DartifactId=ojdbc14 -Dversion=10.2.0.4.0 -Dpackaging=jar
~~~
